...
contract MockVE is IERC721, IERC721Metadata {
    ...
    string public constant name = "veIB";
    string public constant symbol = "veIB";
    ...
    constructor(address token_addr, address token_descriptor) {
        token = token_addr;
    ...
    function tokenURI(uint256 _tokenId) external view returns (string memory) {
        ...
        LockedBalance memory _locked = locked[_tokenId];
        return ITokenDescriptor(tokenDescriptor).tokenURI(_tokenId, _balanceOfNFT(_tokenId, block.timestamp), _locked.end, uint256(int256(_locked.amount)));
    }
